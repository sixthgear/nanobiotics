...
cfg = {
    'name':APP_NAME,
    'version':'1.0',
    'description':'Frantic top-down shooter with a transformation twist!',
    'author':'Spacelab Six',
    'author_email':'sixthgear@sixthgear.ca',
    'url':'https://github.com/spacelabsix/pyweek13',
    
    'py2exe.target':'Nanobiotics',
    'py2exe.icon':'data/icon.ico', #64x64
    'py2exe.binary':APP_NAME, #leave off the .exe, it will be added
    
    'py2app.target':'Nanobiotics',
    'py2app.icon':'data/icon.icns', #128x128
...
# find ./dist/Nanobiotics.app -name \*.so -exec lipo -remove x86_64 -output {} {} \; ; \
# find ./dist/Nanobiotics.app -name \*.dylib -exec lipo -remove x86_64 -output {} {} \; ; \
# find ./dist/Nanobiotics.app -name python -exec lipo -remove x86_64 -output {} {} \; ; \
# find ./dist/Nanobiotics.app -name Python -exec lipo -remove x86_64 -output {} {} \; ; \
# find ./dist/Nanobiotics.app -name Nanobiotics -exec lipo -remove x86_64 -output {} {} \;
